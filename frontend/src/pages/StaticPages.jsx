...
const pages = {
  about: {
    ...
    intro: 'PitchVision brings player data, match context, comparisons, shortlists, and World Cup tracking into one scouting workspace.',
    icon: Users,
    sections: [
      ...
      ['Who it is for', 'PitchVision is designed for football staff, agencies, recruitment teams, and serious fans who want a practical way to explore players, compare profiles, and follow tournament performance.'],
  ...
  how: {
    ...
    intro: 'PitchVision is built around a simple scouting flow: scan, filter, compare, save, and review.',
    icon: HelpCircle,
    sections: [
  ...
  faq: {
    ...
    faqs: [
      ['Where does PitchVision data come from?', 'PitchVision uses provider football feeds, stored player profiles, fixture data, match events, lineups, and local scouting calculations to build the views in the app.'],
      ...
      ['How are player ratings used?', 'Ratings come from available match or season data and are used as one signal. PitchVision pairs ratings with output, per-90 production, role metrics, form, and context rather than treating rating as the only answer.'],
